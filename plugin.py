...
class BasePlugin:
    ...
    def onHeartbeat(self):
        ...
        if self.runInterval <= 0:
            ...
            Devices[4].Update(0,str(Total_kwh*1000))
            Devices[5].Update(0,str(Settable_total_kWh*1000))
            Devices[6].Update(0,str(Settable_import_kWh*1000))
            Devices[7].Update(0,str(Settable_export_kWh*1000))
